...
Code for this document: [link](https://github.com/vadimnazarov/tensorflow-r-examples/3_NeuralNetworks/recurrent_network.Rmd)
  ...
  while (step * batch_size < n_iters) {
    ...
    if (step %% verbose_step == 0) {
      ...
      cat(paste0("Step: ", format(step, width = 5),
                 " batch.loss=", format(loss_val, width = 8),
